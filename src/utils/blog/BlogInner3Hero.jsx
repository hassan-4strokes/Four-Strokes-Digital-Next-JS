      ...
      <div className="left w-full lg:w-[50%] flex flex-col justify-start gap-10">
        ...
        <div className="bottom flex flex-col gap-5">
          <p className="text-lg xl:text-xl tracking-wide font-['Creato_Display']">
            The cross-platform development technology has gained phenomenal
            recognition due to the various benefits reaped through these
            cross-platform development tools and frameworks. With the growing
            demand, numerous Cross-Platform Tools for Mobile App Development and
            frameworks are in the market today, and most mobile application
            development companies are finding this innovative technology.
          </p>
        </div>
      </div>
