      ...
      <div className="left w-full lg:w-[50%] flex flex-col justify-start gap-10">
        ...
        <div className="bottom flex flex-col gap-5">
          <p className="text-lg xl:text-xl tracking-wide font-['Creato_Display']">
            A successful mobile app begins long before final design and
            development. This is an important step in the early phases of app
            design: wireframing. A mobile app wireframe is essentially the
            blueprint of a whole app, showing its structure, layout, and user
            flow. This writing will address wireframing, what it entails, and,
            most importantly, how to create impactful mobile app wireframes to
            lay the groundwork for a smooth experience.
          </p>
        </div>
      </div>
