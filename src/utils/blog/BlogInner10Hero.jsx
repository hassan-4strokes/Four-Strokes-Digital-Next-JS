    ...
    <div className="section w-full flex flex-col lg:flex-row justify-between gap-8 px-[30px] sm:px-[50px] xl:px-[12vw] pb-5 md:pb-24 2xl:pb-32 pt-24 lg:pt-32">
      <div className="left w-full lg:w-[50%] flex flex-col justify-start gap-10">
        ...
        <div className="bottom flex flex-col gap-5">
          <h2
            id="id-1"
            className={`text-2xl md:text-xl lg:text-2xl xl:text-3xl font-semibold text-[#5DD1FF]`}
          >
            Introduction to Cross-Platform App Development
          </h2>
          <p className="text-lg xl:text-xl tracking-wide font-['Creato_Display']">
            Cross-platform websites, such as Airbnb, LinkedIn, WhatsApp, and
            others, are made to offer a uniform user experience across a range
            of browsers and devices. They have all demonstrated their strength!
            Cross-platform frameworks, which enable developers to create apps
            for several platforms using a single codebase, are becoming
            increasingly important in mobile app development: Google's Flutter
            and Microsoft's..NET MAUI are the two most popular options. The
            three primary rivals in developing cross-platform mobile apps are
            React Native, Flutter, and .NET MAUI. This essay will look more
            closely at the Flutter vs .Net MAUI frameworks to help you make an
            informed choice.
          </p>
        </div>
      </div>
...
export default BlogInner10Hero;
