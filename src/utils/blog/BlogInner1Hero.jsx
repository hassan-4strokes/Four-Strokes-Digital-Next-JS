      ...
      <div className="left w-full lg:w-[50%] flex flex-col justify-start gap-10">
        ...
        <div className="bottom flex flex-col gap-5">
          ...
          <p className="text-lg xl:text-xl tracking-wide font-['Creato_Display']">
            Facebook develops and maintains the React native mobile app
            framework, which makes the application ready for use and
            continuously develops it with a high assurance of reliability. It
            utilizes the highly established React library, which is widely used
            in web development. One of React Native’s major benefits is its
            impressive performance. While other approaches rely on web views or
            emulators for execution, the React Native mobile app framework
            compiles directly into native code for each platform, making
            applications fast and responsive on iOS and Android devices.
          </p>
        </div>
      </div>
