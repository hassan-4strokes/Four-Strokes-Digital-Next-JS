      ...
      <div className="left w-full lg:w-[50%] flex flex-col justify-start gap-10">
        ...
        <div className="bottom flex flex-col gap-5">
          <p className="text-lg xl:text-xl tracking-wide font-['Creato_Display']">
            In recent years, since 2010, the mobile app subscription model has
            gained all the attention and significant recognition from users and
            developers, generating attractive and lucrative revenue. In 2011,
            Apple introduced the world’s 1st mobile app subscription model on
            the app store, which completely thrilled and shocked the digital
            world. This model has revolutionized the whole digital world
            completely.
          </p>
        </div>
      </div>
