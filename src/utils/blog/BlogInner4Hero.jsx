      ...
      <div className="left w-full lg:w-[50%] flex flex-col justify-start gap-10">
        ...
        <div className="bottom flex flex-col gap-5">
          <p className="text-lg xl:text-xl tracking-wide font-['Creato_Display']">
            ...
            is a magic wand for today's developers to turn a codebase into apps
            that perfectly suit multiple platforms. Truly, in such a fast world
            where time and resources are scarce, it does seem to be the game
            changer, accelerating the process of development and empowering
            developers to get powerful, feature-rich apps without coding
            separately for each operating system alone, slashing costs.
          </p>
        </div>
      </div>
