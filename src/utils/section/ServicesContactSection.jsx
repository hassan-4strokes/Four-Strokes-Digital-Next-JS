...
const ServicesContactSection = () => {
  ...
  return (
    <div id="contact-form" className="contact-section w-full py-16 xl:py-28">
        ...
        <div className="inner w-full flex flex-col lg:flex-row items-start justify-center sm:justify-between gap-8 2xl:gap-16">
          <div className="left w-full flex flex-col justify-center gap-5 lg:gap-10">
            <div className="inner-top flex flex-col justify-center">
              ...
              <span className="w-full md:w-[80%] text-[14px] lg:text-[16px] xl:text-[18px] leading-[26px] xl:leading-[35px] pt-5 text-zinc-700">
                Success starts with a single step, and we’re here to guide you
                every step of the way. The Four Strokes Digital team is
                passionate about solving challenges and delivering best ever
