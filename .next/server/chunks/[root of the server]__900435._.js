...
"[project]/src/models/blog.model.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const blogSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    ...
    category: {
        type: __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema.ObjectId,
        ref: "Category",
        required: true
    },
    canonical: {
    ...
    alternateText: {
        ...
        required: [
            true,
            "Please Enter An Alternate Text For Your Thumbnail"
        ]
    },
    intro: {
        type: Object,
        required: [
            true,
            "Please Enter Blog Intro Paragraph"
        ]
    },
    content: {
        type: Object,
    ...
    metaTitle: {
        ...
        minLength: [
            3,
            "Meta Title Should Have Atleast 3 Characters"
        ]
    },
    metaDescription: {
        type: String,
        ...
        minLength: [
            10,
            "Meta Description Should Have Atleast 10 Characters"
        ]
    },
    primaryKeyword: {
        type: String,
        required: [
            true,
            "Please Enter A Primary Keyword"
        ]
    },
    tableOfContent: [
        {
...
"[project]/src/models/category.model.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const categorySchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    ...
    slug: {
        ...
        lowercase: [
            true,
            "Category Slug Should Be In Lowercase"
        ],
        trim: [
            true,
            "Category Slug Should Not Contain Spaces"
        ]
    }
}, {
    timestamps: true
});
const Category = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models?.categories || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("categories", categorySchema);
...
const databaseConnection = async ()=>{
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connect("mongodb+srv://hassan4strokes:hassan4strokes@cluster0.pacbc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
        console.log("Database Connected Successfully!");
    } catch (error) {
        console.log(`Some Error Occured While Connecting To Database : ${error}`);
    }
};
const __TURBOPACK__default__export__ = databaseConnection;
}}),
...
"[project]/src/helpers/cloudinary.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/v1/blogs/create-new/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$blog$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/blog.model.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$category$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/category.model.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$database$2f$database$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/database/database.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/helpers/cloudinary.js [app-route] (ecmascript)");
...
;
// Database connection
(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$database$2f$database$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
async function POST(req) {
    try {
        ...
        //   }, { status: 500 });
        // }
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$category$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(formData.get("category"));
        if (!category) {
        ...
        const { title, description, slug, canonical, alternateText, intro, content, metaTitle, metaDescription, primaryKeyword, faq, tableOfContent } = Object.fromEntries(formData);
        const isSlugExists = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$blog$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug
        });
        if (isSlugExists) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$blog$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            title,
            description,
            slug: newSlug,
            canonical,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__900435._.js.map